...
import { testConcurrentFeatures, generatePerformanceReport, PERFORMANCE_THRESHOLDS } from '../../src/utils/performance'
...
describe('React 19 Concurrent Features Performance', () => {
  ...
  it('should validate useDeferredValue performance', async () => {
    ...
    expect(deferredValueTest!.metrics.renderTime).toBeLessThan(PERFORMANCE_THRESHOLDS.MAX_RENDER_TIME * 100)
  ...
  it('should validate useTransition performance', async () => {
    ...
    expect(transitionTest!.metrics.transitionDuration).toBeLessThan(PERFORMANCE_THRESHOLDS.MAX_TRANSITION_DURATION)
  ...
  it('should validate zoom/pan performance', async () => {
    ...
    expect(zoomPanTest!.metrics.frameDrops).toBeLessThanOrEqual(PERFORMANCE_THRESHOLDS.MAX_FRAME_DROPS)
...
describe('Performance Thresholds Validation', () => {
  it('should have reasonable performance thresholds', () => {
    ...
    expect(PERFORMANCE_THRESHOLDS.MAX_TRANSITION_DURATION).toBe(300) // Smooth
    expect(PERFORMANCE_THRESHOLDS.MAX_FRAME_DROPS).toBe(2) // Acceptable
  ...
  it('should validate thresholds against React 19 best practices', () => {
    ...
    expect(PERFORMANCE_THRESHOLDS.MAX_TRANSITION_DURATION).toBeLessThanOrEqual(300) // Smooth transitions
  })
})

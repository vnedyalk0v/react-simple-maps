...
describe('GeographyErrorBoundary', () => {
  ...
  it('should render default error fallback when error occurs', () => {
    ...
    expect(
      screen.getByText('Failed to load geography data'),
    ).toBeInTheDocument();
  ...
  it('should apply correct CSS classes', () => {
    ...
    expect(
      screen.getByText('Failed to load geography data').parentElement,
    ).toHaveClass('rsm-error-content');
    expect(screen.getByText('Failed to load geography data')).toHaveClass(
      'rsm-error-title',
    );

    ...
    <>
      ...
      {metadata && (
        <MapMetadata
          ...
          description={metadata.description || mapMetadataPresets.worldMap.description}
          ...
          ogDescription={metadata.description || mapMetadataPresets.worldMap.ogDescription}
          twitterTitle={metadata.title || mapMetadataPresets.worldMap.twitterTitle}
          twitterDescription={
            metadata.description || mapMetadataPresets.worldMap.twitterDescription
          }

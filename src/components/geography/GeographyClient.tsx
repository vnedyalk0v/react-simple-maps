...
import { GeographyServer, GeographyProcessor, ParseGeographiesFunction } from "./GeographyServer"
...
export function GeographyClient({
  ...
  if (typeof geography === "string") {
    return (
      <Suspense fallback={loadingFallback}>
        <GeographyServer geography={geography} {...(parseGeographies && { parseGeographies })}>
          {children}
        </GeographyServer>
      </Suspense>
    )
  ...
  return (
    <GeographyProcessor geographyData={geography} {...(parseGeographies && { parseGeographies })}>
      {children}
    </GeographyProcessor>
  )
}
